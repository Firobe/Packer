...
void InnerQuadTree::construct(float x1, float y1, float x2, float y2, bitmap& bmap,
    ...
    if (bmap.hasBlack(offsetX, offsetY, length)) {
        ...
        if (bmap.hasWhite(offsetX, offsetY, length)) {
            ...
            int half = length / 2;
            q1 = new InnerQuadTree(x1, y1, xm, ym, bmap, offsetX, offsetY, half,
                                   depth + 1); //top left
            q2 = new InnerQuadTree(xm, y1, x2, ym, bmap, offsetX + half, offsetY, half,
                                   depth + 1); //top right
            q3 = new InnerQuadTree(xm, ym, x2, y2, bmap, offsetX + half, offsetY + half, half,
                                   depth + 1); //bottom right)
            q4 = new InnerQuadTree(x1, ym, xm, y2, bmap, offsetX, offsetY + half, half,
                                   depth + 1); //bottom left
...
InnerQuadTree::InnerQuadTree(float x1, float y1, float x2, float y2, bitmap& bmap,
                             int offsetX, int offsetY, int length, int depth)
...
bool InnerQuadTree::intersectsRec(const InnerQuadTree& q, float offsetX1, float offsetY1,
                                  float offsetX2, float offsetY2) const {
