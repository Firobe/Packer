...
int main() {
    try {
		...
		vector<complex<double>> roots = rotos::cubicRotos(1, -6, 11, -6);
		...
		//x^3 + x^2 + x + 1 : -1, -i, i
		roots = rotos::cubicRotos(1, 1, 1, 1);
		...
		roots = rotos::cubicRotos(2, -24, 108, -216);
		...
		roots = rotos::cubicRotos(0, 1, -10, 1);
		...
		//42x - 42 : 1
		roots = rotos::cubicRotos(0, 0, 42, -42);
